...
df_activities = df_activities.fillna(0, inplace=False , dtype='int64')

pd.to_numeric(df_activities, downcast="integer")
...
df_companies = df_companies.fillna(0, inplace=False , dtype='int64')

pd.to_numeric(df_companies, downcast="integer")
...
df_contacts = df_contacts.fillna(0, inplace=False , dtype='int64')
pd.to_numeric(df_contacts , downcast="integer")
...
df_custom_fields = df_custom_fields.fillna(0, inplace=False , dtype='int64')
pd.to_numeric(df_custom_fields, downcast="integer")
...
df_deals = df_deals.fillna(0, inplace=False , dtype='int64')
pd.to_numeric(df_deals, downcast="integer")
print(df_deals)
...
df_lostreasons = df_lostreasons.fillna(0, inplace=False , dtype='int64')    
pd.to_numeric(df_lostreasons, downcast="integer") 
...
df_pipelines = df_pipelines.fillna(0, inplace=False , dtype='int64')  
pd.to_numeric(df_pipelines, downcast="integer")  
...
df_stages = df_stages.fillna(0, inplace=False , dtype='int64')   
pd.to_numeric(df_stages, downcast="integer") 
