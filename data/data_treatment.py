...
def tratamento_dos_dados():
    ...
    df_activities.drop_duplicates(inplace=True)
    print(df_activities)
    ...
    # Removendo as linhas duplicadas
    df_contacts.drop_duplicates(inplace=True)
    ...
    df_custom_fields.drop_duplicates(inplace=True)
    ...
    # Removendo as linhas duplicadas
    df_lostreasons.drop_duplicates(inplace=True)
    ...
    # Removendo as linhas duplicadas
    df_pipelines.drop_duplicates(inplace=True)
    ...
    # Removendo as linhas duplicadas
    df_stages.drop_duplicates(inplace=True)
